(function () {
  ...
  var dictionary = {
    fr: {
      ...
      'Store Category': 'Catégorie de la boutique', 'Store Subcategory': 'Sous-catégorie de la boutique',
      'Store Product': 'Produit de la boutique', 'Event': 'Événement', 'News Article': 'Article d’actualité',
      'University': 'Université', 'Opportunity': 'Opportunité commerciale', 'Concierge Service': 'Service de conciergerie',
      'Language Course': 'Cours de langue', 'Testimonial': 'Témoignage', 'Hero Slide': 'Diapositive d’accueil',
      'Quick Service': 'Service rapide', 'Partner': 'Partenaire',
    ...
    ru: {
      ...
      'Store Category': 'Категория магазина', 'Store Subcategory': 'Подкатегория магазина',
      'Store Product': 'Товар магазина', 'Event': 'Мероприятие', 'News Article': 'Новостная статья',
      'University': 'Университет', 'Opportunity': 'Деловая возможность', 'Concierge Service': 'Консьерж-услуга',
      'Language Course': 'Языковой курс', 'Testimonial': 'Отзыв', 'Hero Slide': 'Слайд главной страницы',
      'Quick Service': 'Быстрая услуга', 'Partner': 'Партнер',
